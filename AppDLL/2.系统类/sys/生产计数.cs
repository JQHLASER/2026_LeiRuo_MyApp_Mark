...
namespace AppDLL
{
    internal class 生产计数
    {
        internal static QF_WinForm_26.生产计数 JS_sys = new QF_WinForm_26.生产计数("js");
        public 生产计数()
        { 

            JS_sys._使能_零件 = 功能._功能Main .生产计数_零件_使能;
            JS_sys._使能_良品计数 = 功能._功能Main.生产计数_良品_使能;
            JS_sys._使能_不良品计数 = 功能._功能Main.生产计数_不良品_使能;
